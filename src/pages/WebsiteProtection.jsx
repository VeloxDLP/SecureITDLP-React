...
import {
  Globe, Plus, Eye, RotateCcw, Check, AlertTriangle,
  ...
  return (
    <div ref={containerRef} className="relative">
      ...
      <button
        ...
        className={`
          w-full min-h-[44px] flex items-center justify-between gap-2
          ...
          <table className="w-full">
            <thead>
              <tr>
                ...
                <th className={thCls}>Website Names</th>
    ...
    <div className="w-full">
      ...
      <div className="flex items-start justify-between mb-7">
        <div className="flex items-center gap-3">
          ...
          >
            <Globe size={18} className="text-[#7094ff]" />
          </div>
          <div>
            ...
            <p className={`text-[11px] mt-0.5 ${isDark ? 'text-slate-500' : 'text-slate-400'}`}>
              Manage website access policies across endpoints
            </p>
          </div>
        </div>
